...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // Registers a content observer to watch for changes in the uri and in any of its descendants
        // This allows the ContentProvider to tell the UI that the cursor changes like an insert/update in database
